                ...
                <main class="relative container mx-auto bg-white px-4">
                  <div class="test mt-[-10%] w-1/2 mx-auto">
                    <div class="relative pt-[56.25%] overflow-hidden rounded-2xl">
                      <img
                        ...
                        src="https://cdn.britannica.com/q:60/51/190451-050-0E9B50F5/soundblock-Wood-scales-books-stack-background-leather.jpg"
                        alt=""
                      />
                    </div>
                  </div>
                  ...
                  <article class="max-w-prose mx-auto py-8">
                    ...
                    <h2 class="mt-2 text-sm text-gray-500">
                      <strong>Organised by: </strong> <i>{place.addedBy}</i>
                    </h2>
                    <h2 class="mt-2 text-sm text-gray-500">
                      <strong>Date: </strong> <i>{place.date}</i>
                    </h2>
                    <h2 class="mt-2 text-sm text-gray-500">
                      <strong>Category: </strong> <i>{place.category}</i>
                    </h2>
