    ...
    return (
        ...
        <div class="bg-white -mt-10 shadow-lg rounded-lg overflow-hidden p-5" style={{width: "20rem"}}>
          ...
          {place.description.slice(0,40) + '...'}
            ...
            <div className="mt-4"><Link to={`/localcustom/${place.id}`} class="bg-blue-100 text-blue-500 mt-4 rounded p-2 text-sm "><span class="">Read more</span></Link></div>
          </div>
...
export default CardLocalCustom;